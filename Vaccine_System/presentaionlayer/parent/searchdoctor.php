...
<form method="post" action="searchdoctor.php">
	...
	<div class="input-group">
		<label style="font-weight: bold;">Search By:<br>*Doctor ID<br>*Doctor Name<br>*Location</label>
	...
	<div class="input-group">
		...
		$sql6="SELECT  * FROM  doctor   WHERE 	Doctorname=('$dID') OR DoctorID=('$dID') OR location=('$dID')" ;

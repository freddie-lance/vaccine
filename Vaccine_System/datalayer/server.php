...
if (isset($_POST['Register'])) {
	...
	$ChildsName 	= $mysqli -> real_escape_string($_POST['ChildsName']);
...
if (empty($ChildsName)) {
	array_push($errors,"ChildsName is required");
	# code...
}
...
if(count($errors)==0){
  ...
  header('location:../presentaionlayer/parent/index.php');
...
$querydoctor="SELECT * FROM doctor WHERE DoctorID=('$doctorprofile')";
 ...
 if (isset($_POST['treatmentHistory'])) {
		  	header('../presentaionlayer/parent/myinfo.php');
			 ?>
